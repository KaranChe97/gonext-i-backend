...
const { getAll, getOne, create, createMany, edit, deleteOne, getVariant, addVariant, editVariant, deleteVariant, getByCategory } = require("../controllers/inventory");

router.get('/', auth, getAll);
router.get('/byCategory/:categoryId',auth,getByCategory );
